...
from backend.models import (
    User, UserRole,
    PredictionBatch, Prediction, RawApplication, BatchStatus, RiskLevel,
    ModelMetrics, DataDrift, APIRequestLog
)
...
def get_batch(db: Session, batch_id: int) -> Optional[PredictionBatch]:
    """Get batch by ID."""
